...
class UpdateWritingNotification extends Notification
{
    use Queueable;
    public $writing;
    /**
    ...
    {
        return [
            'title'     => 'Update Writing ' . optional($this->writing->writingStudent)->username . ' (' . ($this->writing->writingStudent)->name . ')',
